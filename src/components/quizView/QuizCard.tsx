...
import { CardText, CardMenu, CardFooter } from ".";
...
export const QuizCard = () => {
  ...
  return (
    <Card className="grid h-72 w-full grid-cols-5 grid-rows-5 gap-2 hover:shadow-lg sm:max-w-sm">
      <div className="relative col-span-5 row-span-3 rounded-t-sm bg-muted">
        <Badge className="absolute right-0 m-2">{status}</Badge>
        <Button>hello</Button>
      </div>
